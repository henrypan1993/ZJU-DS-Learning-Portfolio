...
| 类型 | 文件链接 |
| --- | --- |
| **课程笔记** | [25 第十讲 排序（下）.pdf](课程笔记+代码解释+部分课后小测解释/25%20第十讲%20排序（下）.pdf) |
| | [26 第十讲 作业记录（一）.pdf](课程笔记+代码解释+部分课后小测解释/26%20第十讲%20作业记录（一）.pdf) |
| **编程作业** | [10-排序4 统计工龄.py](编程作业/10-排序4%20统计工龄.py) |

### 第十一讲：散列查找

介绍散列表的基本概念、散列函数的设计以及冲突处理方法。

> 说明：由于时间限制，没有来得及做“11-散列2 Hashing”

| 类型 | 文件链接 |
| --- | --- |
| **课程笔记** | [27 第十一讲 散列查找.pdf](课程笔记+代码解释+部分课后小测解释/27%20第十一讲%20散列查找.pdf) |
| | [28 第十一讲 作业记录（一）.pdf](课程笔记+代码解释+部分课后小测解释/28%20第十一讲%20作业记录（一）.pdf) |
| **编程作业** | [11-散列1 电话聊天狂人.py](编程作业/11-散列1%20电话聊天狂人.py) |

### 第十二讲：综合习题选讲

> 该部分为习题讲解，因此无作业代码和相关笔记。
